 ...
 * R2 is S3-compatible so this adapter uses @aws-sdk/client-s3 pointed at the R2 endpoint.
 */
export class R2Provider extends BaseProvider {
  ...
  private buildPublicUrl(key: string): string {
    ...
    // Fall back to the R2 public URL format (requires bucket to have public access enabled).
