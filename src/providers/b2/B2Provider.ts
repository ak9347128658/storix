 ...
 * Uses the S3-compatible B2 endpoint so only @aws-sdk/client-s3 is required.
 */
export class B2Provider extends BaseProvider {
  public readonly providerName = 'b2';
  ...
  constructor(
    ...
    // B2 S3-compatible endpoint: https://s3.<region>.backblazeb2.com
    const region = credentials.region ?? 'us-west-004';
    this.endpointBase = credentials.endpoint ?? `https://s3.${region}.backblazeb2.com`;
